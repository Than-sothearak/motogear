...
import ButtonViewAndDelete from "./ButtonEditAndDelete";
...
const TableComponent = ({
  ...
  return (
    <div className="overflow-y-clip overflow-x-auto text-primarytext">
              ...
              >
                ...
                <td className="px-2">
                  ...
                  type="button"
                    ...
                    className="bg-tertiary whitespace-nowrap text-secondarytext border border-secondary px-2 py-1 rounded-md hover:bg-primary hover:text-primarytext text-sm"
                  >
                    Send message
                  </button>
                </td>
