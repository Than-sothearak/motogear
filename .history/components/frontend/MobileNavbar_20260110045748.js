...
const MobileNavbar = ({ handleClick, isOpen,menuData }) => {
  ...
  return (
    ...
    ><CiMenuBurger size={24} /></button>
      <div className={`bg-primary text-primarytext lg:w-1/2 w-full h-full overflow-y-auto transition-all duration-500 ease-in-out  ${isOpen ? "translate-x-0" : "-translate-x-full"}
