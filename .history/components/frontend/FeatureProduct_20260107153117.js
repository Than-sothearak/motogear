  ...
  return (
    <section className="py-20 bg-primary">
      <div className="container mx-auto px-4">
        ...
        <div
          ref={scrollRef} // ✅ attach ref here only
          className="overflow-x-auto snap-x snap-mandatory flex gap-6 min-w-max"
        >
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((item) => (
            <div
              key={item}
              className="group min-w-[260px] rounded-md hover:shadow-lg transition flex-shrink-0"
            >
              {/* Image */}
