  ...
  return (
    <div className="container mx-auto p-4 lg:flex lg:gap-8">
      ...
      <div className="lg:w-1/2">
        <div className="relative w-full h-[300px] rounded-md border overflow-hidden mb-4">
      ...
      return (
        <button
          ...
          className={`relative px-4 py-2 border rounded-md transition-all
            ...
            ${
              !hasStock
                ? "opacity-100 cursor-not-allowed line-through"
                : "hover:border-primary"
            }
          `}
        >
          {size}
          {!hasStock && <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-3xl" >X</div>}
        </button>
      );
    })}
  </div>
        ...
        <div className="mt-6 flex items-center gap-4">
          ...
          <button
            className={`bg-tertiary text-primary px-6 py-2 border rounded-md font-semibold hover:bg-primary hover:text-primarytext transition-all ${
