...
export default function ProductSinglePage({ product }) {
  ...
  return (
    <div className="container mx-auto lg:flex lg:gap-8 my-10">
      {/* Left: Image gallery */}
      <div className="lg:w-1/2 flex flex-col justify-start items-center gap-4 mb-10">
        <div className="lg:w-1/2 p-4 lg:p-0 w-full">
       ...
       <div className="flex flex-nowrap gap-2 pb-2 max-w-[300px] overflow-x-auto overflow-y-hidden">
  {imageUrls.map((img, idx) => (
    <div
      key={`main-${idx}`}
      className={`relative w-32 h-20 border rounded-md overflow-hidden cursor-pointer shrink-0
