        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="flex gap-8 relative">
            {Object.keys(menuData).map((item) => (
              ...
              >
                <button className="font-medium text-gray-700 hover:text-black transition h-full">
                  {item}
                </button>

                {/* DROPDOWN */}
                {activeMenu === item && (
                  <div className="absolute left-0 top-full mt-4 w-72 bg-white shadow-xl rounded-xl p-4 border">
