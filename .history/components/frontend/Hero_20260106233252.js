  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      >
           ...
           <div className="absolute inset-0 flex items-center justify-center text-center px-4 z-50">
              <div>
                ...
                <button className="bg-tertiary hover:bg-tertiary/80 px-8 py-4 text-primary font-semibold uppercase rounded-md">
                  Shop Now
                </button>
              </div>
            </div>
