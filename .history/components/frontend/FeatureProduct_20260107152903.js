...
export default function FeaturedProducts() {
  ...
  if (!scrollRef.current) return; // ❌ Prevent null error
    ...
    return (
        <section className="py-20 bg-primary">
            <div className="container mx-auto px-4" ref={scrollRef}>
                ...
                <div className="container flex justify-center gap-10"  ref={scrollRef}  >
                    <button
                        onClick={() => scroll("left")}
                        className="left-2 top-1/2 z-10 bg-white p-2 shadow"
                    >
                        ◀
                    </button>
                    ...
                    <button
                        ...
                        className=" right-2 top-1/2 z-10 bg-white p-2 shadow"
                    >
                        ▶
                    </button>
                </div>
