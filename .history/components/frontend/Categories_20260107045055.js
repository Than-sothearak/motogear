...
export default function Categories() {
  return (
    <section className="py-16">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-6 container mx-auto transition-all duration-300 ease-in-out">
        {categories.map((cat) => (
          <div
            key={cat}
          ...
          <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white z-10 hover:scale-105">
  {cat}
</h1>
          </div>
        ))}
