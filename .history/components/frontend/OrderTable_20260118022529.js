...
export const OrderTable = ({ initialOrders, initialHasMore, user }) => {
    ...
    return (
        <div className="relative bg-white border rounded-sm shadow p-6 w-full max-h-full">
            ...
            <div className="overflow-x-auto whitespace-nowrap">
                <table className="w-full text-sm max-sm:overflow-x-scroll max-w-full">
                    ...
                    <tbody>
                       ...
                       ): <div className='flex justify-center m-8 w-full'>No order history</div>}
                    </tbody>
                </table>
            </div>
        ...
        `}
            ...
            {hasMore && orders.length > 0 && (
             <div className='container m-auto flex justify-center'>
                ...
                disabled={isPending}
                    onClick={loadMore}
                    className={`mt-4 px-4 py-2 bg-tertiary text-primary hover:bg-tertiary/80  rounded-sm  ${isPending ? 'opacity-45 cursor-wait' : 'opacity-100'}`}
                >
