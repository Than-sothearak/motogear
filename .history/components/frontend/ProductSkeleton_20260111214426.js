...
const ProductBoxSkeleton = () => {
  return (
    <div className="border rounded-xl p-3 space-y-3 animate-pulse bg-white dark:bg-neutral-900">
      {/* Image */}
      <div className="h-48 aspect-square bg-gray-200 dark:bg-gray-700 rounded-lg" />
