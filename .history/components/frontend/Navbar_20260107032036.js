    ...
    return (
        <header className="top-0 z-50 absolute w-full border-b border-tertiary bg-primary max-md:p-2">
            <div className="container mx-auto ">
                <div className="flex items-center justify-between flex-col order-2">
                  <MobileNavbar  handleClick={handleClick} isOpen={isOpen} menuData={menuData}/>
                    {/* LEFT MENU */}
                    <nav className="flex gap-8 h-full max-md:hidden">
                    ...
                    {/* LOGO */}
                    <div className="text-2xl font-black tracking-wide italic order-4">
