...
export default function ProductSinglePage({ product, session }) {
  ...
  const { availableColors, availableSizes, selectedColor, setSelectedColor, selectedSize, setSelectedSize, stock, mainImage, } = useProductVariants(product.variants, product.imageUrls);
