...
function Footer() {
  ...
  return (
    <div className="z-20 sticky bottom-0 bg-primary flex justify-center lg:hidden">
      <div className=" w-full h-[200px] shadow-xl rounded-t-xl border-t border border-t-black">
