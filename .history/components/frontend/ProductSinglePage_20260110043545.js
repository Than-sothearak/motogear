  ...
  return (
    <div className="container mx-auto lg:flex lg:gap-8 my-10">
      ...
      <div className="lg:w-1/2 flex flex-col justify-start items-center gap-4 mb-10">
        ...
        <div className="flex gap-2 pb-2 max-w-[300px] overflow-scroll">
          {imageUrls.map((img, idx) => (
            <div
              key={idx}
              className={`relative  w-32 h-20 border rounded-md overflow-hidden cursor-pointer ${mainImage === img ? "ring-2 ring-primary" : ""
                }`}
