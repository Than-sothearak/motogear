  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center text-center px-4 pointer-events-none">
        <div>
          <h1 className="text-8xl font-black text-white mb-4 uppercase">
            {slides[0].title}
          </h1>
          <p className="text-lg md:text-xl text-gray-200 mb-8">
            {slides[0].subtitle}
          </p>
           <button className="bg-tertiary hover:bg-tertiary/80 px-4 py-1 rounded-full text-2xl text-primary font-semibold uppercase hover:cursor-pointer">
            Shop Now
          </button>
        </div>
      </div>
