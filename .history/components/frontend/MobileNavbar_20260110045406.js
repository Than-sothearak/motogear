...
const MobileNavbar = ({ handleClick, isOpen,menuData }) => {
  ...
  return (
    ...
    ><CiMenuBurger size={24} /></button>
      <div className={`bg-primary text-primarytext md:w-1/2 h-full overflow-y-auto transition-all duration-500 ease-in-out  ${isOpen ? "translate-x-0" : "-translate-x-full"}
