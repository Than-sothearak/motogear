...
const Navbar = ({session, categories}) => {
  ...
  function handleClick() {
    ...
    return (
        <header className="top-0 z-50 sticky w-full border-b bg-primary max-md:p-2">
            <div className="container mx-auto font-semibold">
                <div className="flex items-center justify-between max-md:flex-col">
                   {/* LOGO */}
                    ...
                    {/* LEFT MENU */}
                    <nav className="flex gap-8 h-full max-md:hidden max-md:order-3">
                                        ...
                                        <div className="bg-primary shadow-xl px-4">
                                            <ul className="flex gap-4 justify-center">
                                                {categories[item].map(({ name, slug }) => (
                                                    <Link
                                                    href={`/categories/${categories[item]}/${slug}`}
                                                        key={name}
                    ...
                    {/* SEARCH */}
                    <div className="flex items-center space-x-4 max:md-order-2 max-md:w-full">
              ...
              focus:outline-none focus:ring-2 focus:ring-black"
                        ...
                        {/* Account */}
                        <div className="flex items-center space-x-2 max-md:order-3">
                          <Cart />
