...
function Footer() {
  ...
  return (
    <div className="z-20 sticky h-32 bottom-0 bg-primary flex justify-center lg:hidden">
      <div className=" w-full shadow-xl rounded-t-xl border-t border border-t-black">
