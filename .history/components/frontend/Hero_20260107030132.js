...
<div className="absolute inset-0 flex items-center justify-center text-center px-4">
  <div>
    {/* h1 Behind Image */}
    <h1 className="text-8xl font-black text-primarytext mb-4 uppercase z-0 absolute top-0 right-0 w-full">
      {slides[0].title}
    </h1>

    {/* Subtitle + Button On Top */}
  <div className="absolute w-full">
      <p className="text-lg md:text-xl text-gray-200 mb-8 relative z-20">
      {slides[0].subtitle}
    </p>
