...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen overflow-hidden container mx-auto">
     {/* 🔥 FIXED OVERLAY (NOT SLIDING) */}
<div className="absolute inset-0 flex items-center justify-center text-center px-4">
  <div>
    {/* h1 Behind Image */}
    <h1 className="text-8xl font-extrabold text-primarytext mb-4 uppercase z-0 absolute top-10 right-0 w-full">
      {slides[0].title}
    </h1>
...
{/* SLIDER */}
<div
  className={`flex h-full w-96 ${animate ? "transition-transform duration-1000 ease-in-out" : ""}`}
  style={{
