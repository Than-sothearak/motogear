...
const ProductCard = ({productName, basePrice, brandName, imageUrls}, _id) => {
  ...
  return (
     <div
              key={_id}
              className="max-w-[260px] flex-shrink-0 rounded-md hover:shadow-lg transition"
            >
              <div className="relative h-56 bg-gray-100 overflow-hidden">
                ...
                <Image src={imageUrls[0]} fill alt={`image ${imageUrls}`} className='object-cover'/>
              </div>
              <div className="p-4">
                <h3 className="font-semibold whitespace-normal group-hover:underline">
                  {productName}
                </h3>
