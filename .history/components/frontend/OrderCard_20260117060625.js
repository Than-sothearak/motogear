...
export const OrderCard = ({ order }) => {
  ...
  return (
    <div className="bg-white">
      {/* Header */}
      <div className="mb-2">
        <h3 className="text-lg font-semibold uppercase">Order ID: #{order._id}</h3><div className='text-xs border'>
            {order.paid ? <div className='flex items-center text-green-600'><Check size={10}/>Paided</div> : 'Unpaid'}
        </div>
