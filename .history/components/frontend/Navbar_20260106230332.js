...
const Navbar = () => {
  ...
  return (
    <header className="border-b bg-white sticky top-0 z-50 relative">
      <div className="container mx-auto">
        <div className="flex items-center justify-between">

          {/* LEFT MENU */}
          <nav className="flex gap-8 relative h-full ">
            {Object.keys(menuData).map((item) => (
              <div
                key={item}
                className=" h-14  flex items-center hover:border-b"
              ...
              >
                ...
                {/* DROPDOWN */}
                {activeMenu === item && (
                  <div className="absolute left-0 top-full w-full bg-white shadow-xl rounded-xl border">
