...
const Navbar = () => {
    ...
    return (
        <header className="top-0 z-50 absolute w-full border-b border-tertiary bg-primary">
                    ...
                    <nav className="flex gap-8 h-full ">
                        {Object.keys(menuData).map((item) => (
                            ...
                            >
                                ...
                                {/* DROPDOWN */}
                                {activeMenu === item && (
                                    <div className="absolute left-0 mt-10 top-full w-full bg-primary shadow-xl px-4 " onMouseEnter={() => setActiveMenu(item)}
                                        onMouseLeave={() => setActiveMenu(null)}>
