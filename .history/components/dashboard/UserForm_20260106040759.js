"use client";
import ChooseSingleImageFile from "@/components/dashboard/ChooseSingleImage";
          ...
          <div className="w-full md:w-2/3 space-y-6">
            <div className="text-xs grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  className="text-lg bg-primary border w-full px-4 py-2.5 rounded-lg transition-all border-secondary appearance-none bg-transparent outline-none focus:ring-2 focus:border-none"
                />
                {state?.errors?.name && (
              ...
              <div>
                ...
                <input
                  ...
                  className="text-lg bg-primary border w-full px-4 py-2.5 rounded-lg transition-all appearance-none bg-transparent border-secondary outline-none focus:ring-2 focus:border-none"
                />
                {state?.errors?.email && (
                  <p className="mt-1 text-lg text-red-600">
                    {state.errors.email}
              ...
              <div>
                ...
                <input
                  ...
                  className="text-lg bg-primary border w-full px-4 py-2.5 rounded-lg transition-all appearance-none bg-transparent outline-none focus:ring-2 focus:border-none border-secondary "
                />
                {state?.errors?.phone && (
              ...
              {session?.user?.isAdmin ? (
                ...
                <input
                  ...
                  className="text-lg bg-primary hidden border w-full border-secondary  px-4 py-2.5 rounded-lg transition-all appearance-none bg-transparent outline-none focus:ring-2 focus:border-none"
                />
              )}
            </div>
               ...
               <div className="flex items-center gap-4 max-md:flex-col">
                <div className="w-full">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="123 Main St, City, Country"
                    className="text-lg bg-primary border w-full border-secondary  px-4 py-2.5 rounded-lg transition-all appearance-none bg-transparent outline-none focus:ring-2 focus:border-none"
                  />
                </div>
                ...
                <div className="w-full">
                  ...
                  >
                    <option value="active" className="text-primarytext">
                      Active
                    </option>
                    <option value="deactivated" className="text-primarytext">
                      Deactivated
                    </option>
                  </select>
            ...
            {!userId ? (
              <div className="">
                ...
                <input
                  ...
                  className="bg-primary border w-full px-4 py-2.5 rounded-lg transition-all appearance-none bg-transparent outline-none focus:ring-2 focus:border-none"
                />
            ...
            <div className="">
              <button
                type="submit"
                disabled={isPending}
                className={`text-primarytext w-full text-primary bg-tertiary hover:bg-secondary rounded-xl py-3 ${
