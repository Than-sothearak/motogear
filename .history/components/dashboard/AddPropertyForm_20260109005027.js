    ...
    <div className="flex flex-col gap-2 border p-4 rounded-md bg-slate-100 ">
      <button
        ...
        className={`${anyPropertyEmpty
            ? "cursor-not-allowed bg-primary whitespace-nowrap"
            : "hover:bg-secondary bg-tertiary"
          }
           p-2 text-secondarytext hover:text-primarytext rounded-md flex items-center gap-2 text-base hover:bg-tertiary/80 hover:text-primary`}
        onClick={addPart}
