    ...
    <div className="">
          ...
          {file.file.type.startsWith("image/") && (
            <>
              <Image
                ...
                src={file.preview}
                className="w-32 h-32 object-cover rounded-full bg-primary p-1"
      ...
      <div className={`${editClicked ? ' ' : 'hidden'}  w-full h-full absolute bg-white shadow-lg p-4 border rounded-lg top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2`}>
        ...
        <input
          ...
          type="file"
          accept="image/*"
          className="text-center w-full mt-4 p-2 rounded-md bg-primary border-none text-xs focus:ring-0 focus:outline-none"
        />
