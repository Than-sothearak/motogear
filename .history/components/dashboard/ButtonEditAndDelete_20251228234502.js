  ...
  return (
    ...
    >
      ...
      >
        <Link
          href={link}
          className="bg-tertiary  text-primarytext border border-secondary px-2 py-1 rounded-md hover:bg-primary hover:text-primarytext text-sm"
        >
          Edit
        </Link>
        <button
      ...
      {showConfirmation &&
        createPortal(
          <div className="w-full h-full fixed inset-0 bg-black/80 flex justify-center items-center">
            <div className="bg-primary text-secondarytext p-6 rounded-md w-[300px]">
