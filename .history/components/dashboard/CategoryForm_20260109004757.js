  ...
  return (
    <form action={action} className="space-y-2 text-sm">
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <div className="flex flex-col">
                <input
                  ...
                  className="w-full p-2 rounded-md bg-primary border text-xs focus:ring-0 focus:outline-none"
                />
              ...
              <div className="flex flex-col">
                <input
                  placeholder="Enter slug (helmet)"
                  type="text"
                  name="category"
                  value={formData.slug}
                  onChange={handleChange}
                  className="w-full p-2 rounded-md bg-primary border-none text-xs focus:ring-0 focus:outline-none"
                />
      ...
      <button
        type="submit"
        disabled={isPending}
        className={`text-secondarytext p-2 bg-tertiary w-full mt-6 hover:bg-secondary hover:text-primarytext rounded-md ${isPending ? "opacity-50 cursor-not-allowed" : ""
          }`}
      >
