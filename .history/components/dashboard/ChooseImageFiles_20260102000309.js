...
export default function ChooseImageFile() {
    ...
    return (
        <div className="">
            ...
            >
                <div className={`${files.length <= 0 ? "hiiden" : ""
                    } w-full h-full flex justify-center items-center gap-8 flex-col border-dashed border-secondary mt-2 rounded-md border-2 p-8`}>
