    ...
    >
      <div>
        <button
          ...
          type="button"
          className="hover:text-primarytext flex justify-center items-center gap-2 text-sm font-bold text-primarytext mb-1 text-center rounded-md"
        >
      ...
      {isCLicked && (
        <div className="bg-primary rounded-2xl w-1/2 max-md:w-full p-2 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50">
          <div className="flex flex-col">
            ...
            <div className="p-4 flex flex-col gap-4">
              ...
              <button
                className={`text-primarytext py-3 rounded-xl bg-tertiary hover:bg-secondary font-bold ${
