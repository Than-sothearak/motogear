            ...
            >
              <div className="flex gap-2 items-center w-full h-full max-lg:flex-wrap justify-between">
                ...
                <div className="border-l px-2">
                  <p className="">Size:</p>
                  <p className="bg-tertiary text-primary  p-2 rounded-xl">
                    {v.size}
                  </p>
                </div>
                <div className="border-l px-2 flex flex-col items-center justify-center">
                  <p className="">Color</p>
                  <p className="bg-tertiary text-primary flex p-2 rounded-xl">
                    {v.color}
                  </p>
                </div>
                ...
                <div className="border-l px-2">
                  <p className="">Stock</p>
                  <p className="bg-tertiary text-primary flex p-2 rounded-xl w-full">
                    {v.stock}
                  </p>
                </div>
                ...
                <div className="border-l px-2">
                  <p className="">SKU</p>
                  <p className=" flex py-2 rounded-xl w-full lg:whitespace-nowrap max-w-64 overflow-clip">
                    {v.sku}
                  </p>
                </div>
              </div>
