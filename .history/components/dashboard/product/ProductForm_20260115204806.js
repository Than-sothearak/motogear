              ...
              <div className="flex gap-2 items-center">
                {!isEditing ? (
                  <button
                    ...
                    className="border text-primaryText px-6 py-2  hover:bg-tertiary hover:text-primary"
                  >
                    Edit
                  </button>
                ) : (
                  <button
                    ...
                    className="bg-tertiary text-white px-6 py-2  h-full hover:bg-tertiary/80"
                  >
                    Cancel
                  </button>
                )}
