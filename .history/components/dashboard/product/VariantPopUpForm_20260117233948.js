    ...
    <div className="flex gap-4 max-2xl:flex-col">
      {editingIndex !== null && (
        ...
        <div className="">
          ...
          ></div>
        <div className="px-3 space-y-2 fixed top-1/2 left-1/2 z-50 w-96 max-w-full transform -translate-x-1/2 -translate-y-1/2 bg-white border rounded p-4 shadow-lg">
