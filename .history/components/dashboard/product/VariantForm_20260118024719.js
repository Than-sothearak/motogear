        ...
        <div className="px-3 space-y-2 text-sm">
         ...
         {isEditing &&
          <button
            ...
            type="button"
            className=" bg-tertiary hover:bg-tertiary/80 text-white px-4 py-2 rounded-lg whitespace-nowrap"
          >
            Add Property
          </button>}
        </div>
        ...
        {isEditing && (
          <div className="px-3 space-y-2">
            <button
              onClick={addVariants}
              type="button"
              className="mt-2 bg-tertiary hover:bg-tertiary/80 text-white px-4 py-2 rounded-lg whitespace-nowrap flex gap-2"
            >
