              ...
              <div className="flex gap-2">
                {!isEditing ? (
                  <button
                    ...
                    className="border text-primaryText px-4 py-1 rounded 0 hover:bg-tertiary hover:text-primary"
                  >
                    Edit
                  </button>
                ) : (
                  <button
                    ...
                    className="bg-tertiary text-white  py-2 rounded-lg hover:bg-tertiary/80"
                  >
                    Cancel
                  </button>
                )}
