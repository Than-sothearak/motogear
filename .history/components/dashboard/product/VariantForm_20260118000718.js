  ...
  return (
      ...
      <div className="border rounded-md py-4 w-full">
       ...
       <div className="flex flex-col gap-2 text-sm">
         {variants.map((v, index) => (
          <div key={v.sku} className="flex gap-2 items-center border">
   <div className="rounded-md">
           ...
           <div className="border-l px-2">
            <p className="">Size:</p>
             <p className="bg-tertiary text-primary flex p-2 rounded-xl text-center flex items-center">{v.size}</p>
           </div>
    <div className="border-l px-2">
            <p className="">Color</p>
             <p className="bg-tertiary text-primary flex p-2 rounded-xl">{v.size}</p>
           </div>
