                    ...
                    {!v.images && (
                      <div className="">
                        <label
                          className={`${
                            !v.image ? "" : "hidden"
                          } flex flex-col items-center h-11 justify-center w-16 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-tertiary/40 transition`}
                        >
