          ...
          {variants.map((v, i) => (
            ...
            >
              <div className="flex gap-2 items-center">
                <div className="flex p-1 text-sm items-center">Size:<p className="bg-tertiary/50 text-primary px-2 text-sm rounded-2xl">{v.size} </p></div>
                <div className="flex p-1 text-sm items-center">Color:<p className="bg-tertiary/50 text-primary px-2 text-sm rounded-2xl">{v.color} </p></div>
                <div className="flex p-1 text-sm items-center">price:<p className="bg-tertiary/50 text-primary px-2 text-sm rounded-2xl">${v.price} </p></div>
                <div className="flex p-1 text-sm items-center">Stock:<p className="bg-tertiary/50 text-primary px-2 text-sm rounded-2xl">{v.stock} </p></div>
                <div className="flex p-1 text-sm items-center whitespace-nowrap">SKU:<p className="bg-tertiary/50 text-primary px-2 text-sm rounded-2xl">{v.sku || "-"} </p></div>
