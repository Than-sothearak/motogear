...
function ProductForm({ productData, categories }) {
 ...
 try {
  ...
  return (
    <div className="m-auto p-6 max-sm:px-2 max-sm:py-3 bg-white rounded-xl shadow-md">
          ...
          <div>
            ...
            {!isEditing ? (
              <button
                ...
                className="border text-primarytext px-4 py-2 rounded-sm hover:bg-tertiary/80 hover:text-primary"
              >
                Edit
              </button>
            ) : (
            ...
            {/* Submit Button */}
              ...
              <div className="flex justify-end ">
                <button
                  type="submit"
                  className="bg-tertiary text-white px-6 py-2 rounded-sm hover:bg-tertiary/80"
                >
                  {productData ? isPending ? "Updating..." : 'Update Product' : "Save Product"}
                </button>
              </div>
            )}
          </div>
    ...
    <p className="text-sm">Manage your product details</p>        
        ...
        <div>
          <div
            className="space-y-4 flex flex-col justify-end mt-4"
          >
              ...
              <div className="flex justify-start gap-8 w-full flex-wrap">
                {formData?.imageUrls &&
                  formData?.imageUrls.map((image, index) => (
                    <div
                      className={`relative z-0 aspect-square rounded-md bg-tertiary/10 group w-52 gap-4`}
                      key={index}
                    >
                      <Image
                        fill
