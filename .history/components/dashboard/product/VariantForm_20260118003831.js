...
const VariantForm = ({
  ...
  return (
    <div className="flex gap-4 max-2xl:flex-col">
      ...
      {isEditing &&   <div className="px-3 space-y-2">
          <button
            onClick={addVariants}
            type="button"
...
<div key={v.sku} className="flex justify-between items-center w-full">
            <div className="flex gap-2 items-center w-full h-full max-lg:flex-wrap">
           ...
           <div className="border-l px-2">
            ...
            <p className="">Price</p>
             <p className="bg-tertiary text-primary flex p-2 rounded-xl w-full">{v.price}$</p>
               ...
               <div className="border-l px-2">
            <p className="">SKU</p>
             <p className=" flex py-2 rounded-xl w-full lg:whitespace-nowrap max-w-64 overflow-clip">{v.sku}</p>
           </div>
       

          </div>

     {isEditing &&          <div className="w-full flex gap-2  h-full justify-end">
