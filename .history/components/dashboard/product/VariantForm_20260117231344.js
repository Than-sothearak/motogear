...
const VariantForm = ({
  ...
  return (
      ...
      <div className="border rounded-md py-4 w-full">
       ...
       <div className="flex flex-col gap-2 p-2 text-sm">
         {variants.map((v, index) => (
          <div key={v.sku} className="flex gap-2 items-center border p-2">
   ...
   <div className="rounded-md">
                    ...
                    {!v.images && (
                      <div className="">
                        <label
                          className={`${
                            !v.image ? "" : "hidden"
                          } flex flex-col items-center justify-center h-11 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-tertiary/40 transition`}
                        >
                        ...
                        {v.image && (
                          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 items-center">
                            <div className="relative w-11 aspect-square rounded-lg overflow-hidden border">
                              <Image
                                src={v.image.preview}
                                alt="preview"
                                fill
           ...
           <div className=" bg-tertiary text-primary flex p-2 rounded-xl">
            <p>Size:</p>
             <p>{v.size}</p>
           </div>

           <div className="flex bg-tertiary text-primary p-2 rounded-xl">
            <p>Color:</p>
             <p>{v.color}</p>
           </div>
            ...
            <p>Price:</p>
             <p>${v.price}</p>
              ...
              <div className="flex bg-tertiary text-primary p-2 rounded-xl whitespace-nowrap">
            <p>SKU:</p>
             <p>{v.sku}</p>
           </div>
          </div>
