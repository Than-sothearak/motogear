...
const AnalysisGrid = ({ users, payments, booking, parking, roomCount }) => {
  ...
  return (
    <div className="rounded-lg grid grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 text-primarytext hover:bg-tertiary hover:text-secondarytext">
      ...
      className=" w-full justify-start items-start flex gap-4 p-4 bg-primary rounded-lg hover:bg-primarydark transition-all duration-300">
        <div>
          <BiUserPlus size={28} />
        </div>
