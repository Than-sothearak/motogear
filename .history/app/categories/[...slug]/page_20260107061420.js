...
const {slug} = await params
  return (
    <div className='w-full bg-secondary mx-auto h-full flex gap-10 flex-col'>
      <div className='container mx-auto mt-10 space-y-10 bg-primary'>
        <div>
...
<div   key={item._id} className='space-y-4'>
    <div
      ...
      className="relative w-full h-40 sm:h-56 md:h-64 lg:h-80 group transition cursor-pointer overflow-hidden rounded-sm"
    >
      <Image
      ...
      />
        ...
        <div className=''>
          <p className='text-sm'>{item.productName} {item.brandName}</p>
