...
<div   key={item._id}>
    <div
      ...
      className="relative w-full h-40 sm:h-56 md:h-64 lg:h-80 group transition cursor-pointer overflow-hidden rounded-lg"
    >
      <Image
      ...
      />
        ...
        <div className=''>
          ...
          <h1 className='font-black text-3xl'>Price {item.basePrice}$</h1>
        </div>
</div>
  ))}
</div>
