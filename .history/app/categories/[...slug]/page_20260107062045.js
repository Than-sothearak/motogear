    ...
    >
      ...
      />
        ...
        <div className='flex justify-between max-md:flex-wrap'>
          <div>
            <p className='text-xs max-w-48 overflow-clip whitespace-nowrap gap-4'>{item.productName} {item.brandName}</p>
          <h1 className='font-black text-xl'>${item.basePrice} USD</h1>
          </div>
          <button className='bg-tertiary text-primary px-4 rounded-sm hover:bg-tertiary/80 whitespace-nowrap'>Add to cart</button>
        </div>
</div>
  ))}
</div>
