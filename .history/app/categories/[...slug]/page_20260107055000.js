...
const products = [
  {
    _id: ObjectId("695a88018839594ba3246b66"),
    brandName: "ls2",
    ...
    discount: 10,
    imageUrls: [
      "/images/ls2-challenger-1.jpg",
      "/images/ls2-challenger-2.jpg",
      "/images/ls2-challenger-3.jpg"
    ],
    category: ObjectId("6954ef97d2f965e2125bdda3"),
    variants: [
  ...
  {
    _id: ObjectId("695a88018839594ba3246b67"),
    brandName: "shoei",
    ...
    discount: 5,
    imageUrls: [
      "/images/shoei-rf1400-1.jpg",
      "/images/shoei-rf1400-2.jpg"
    ],
    category: ObjectId("6954ef97d2f965e2125bdda3"),
    variants: [
  ...
  {
    _id: ObjectId("695a88018839594ba3246b68"),
    brandName: "agv",
  ...
  {
    _id: ObjectId("695a88018839594ba3246b69"),
    brandName: "arai",
    ...
    discount: 15,
    imageUrls: [
      "/images/arai-rx7v-1.jpg",
      "/images/arai-rx7v-2.jpg"
    ],
    category: ObjectId("6954ef97d2f965e2125bdda3"),
    variants: [
  ...
  {
    _id: ObjectId("695a88018839594ba3246b70"),
    brandName: "bell",
  ...
  {
    _id: ObjectId("695a88018839594ba3246b71"),
    brandName: "ls2",
    ...
    discount: 5,
    imageUrls: [
      "/images/ls2-advant-1.jpg",
      "/images/ls2-advant-2.jpg"
    ],
    category: ObjectId("6954ef97d2f965e2125bdda3"),
    variants: [
  ...
  {
    _id: ObjectId("695a88018839594ba3246b72"),
    brandName: "hjc",
    ...
    discount: 0,
    imageUrls: [
      "/images/hjc-i70-1.jpg",
      "/images/hjc-i70-2.jpg"
    ],
    category: ObjectId("6954ef97d2f965e2125bdda3"),
    variants: [
  ...
  {
    _id: ObjectId("695a88018839594ba3246b73"),
    brandName: "nolan",
  ...
  {
    _id: ObjectId("695a88018839594ba3246b74"),
    brandName: "mt",
  ...
  {
    _id: ObjectId("695a88018839594ba3246b75"),
    brandName: "scorpion",
    ...
    discount: 12,
    imageUrls: [
      "/images/scorpion-r1-1.jpg",
      "/images/scorpion-r1-2.jpg"
    ],
    category: ObjectId("6954ef97d2f965e2125bdda3"),
    variants: [
...
const {slug} = await params
  return (
    <div className='w-full bg-secondary mx-auto h-screen flex gap-10 flex-col'>
      <div className='container mx-auto mt-10 h-screen space-y-10'>
        <div>
        <h1 className='font-bold text-3xl uppercase'>Products (home page): {slug}</h1>
      </div>

      {products.map(item => (
        <div key={item._productName}>
