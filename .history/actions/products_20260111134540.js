...
export async function getProductFilter(slug, catParams, query, limit = 8, page = 1) {
  try {
    ...
    return { products, categories: allCategories, count, ITEM_PER_PAGE };
